...
'''關閉資料庫連接'''
from model import AuthManager, db_session as db1
...
from mes import bp  # 登入、使用者、權限功能
app.register_blueprint(bp)
app.add_url_rule("/", endpoint='index')

from mes.framework import bp  # 主要頁面框架功能、功能測試
app.register_blueprint(bp)
app.add_url_rule("/frame", endpoint='index')

from mes.production import bp  # 現場管理功能
app.register_blueprint(bp)
app.add_url_rule("/production", endpoint='index')

from mes.schedule import bp  # 生產管理功能
app.register_blueprint(bp)
app.add_url_rule("/schedule", endpoint='index')


from mes.revise import bp  # 數據管理功能
app.register_blueprint(bp)
